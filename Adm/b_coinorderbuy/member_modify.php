...
if ($div == "1") {
	$table_orderbuy = $table_orderbuy;
} else if ($div == "2") {
	$table_orderbuy = $table_orderbuy_mal;
}

$query_pdo = "SELECT b_no,b_state,b_ordermost,b_orderfees,b_closecost,b_closefees,b_orderprice,b_pricetotal,b_closeprice,b_closetotal,b_no1,b_userno,b_id,b_closedate,b_delete,b_ip,b_signdate,b_div,b_pay FROM $table_orderbuy WHERE b_no=? ";
...
<script language="javascript">
	...
	function go_list() {
		document.form.action = "member.php?keyfield=<?= $keyfield ?>&key=<?= $key ?>&b_statee=<?= $b_statee ?>&b_div_div=<?= $b_div_div ?>&page=<?= $page ?>";
		document.form.submit();
	}
</script>
...
<table width="1100"  border="0" cellspacing="0" cellpadding="0">
			...
			<form name="form" method="post">
				<tr>
					<td colspan=2><img src="../image/icon2.gif" width=45 height=35 border=0> <b><?=M_BUY.M_ORDER.M_HIS?>(<?= $b_no ?>)</b></td>
				</tr>
				<tr>
				...
				<tr>
					<td width=105 height="30">
						<div align="center">
							<font size="2" face="돋움"><?=M_MARKET?></font>
						</div>
					</td>
					<td height="30" colspan="3" align="left">
						<select name="b_pay">
				...
				<tr>
					<td width=115 height="30">
						<div align="center">
							<font size="2" face="돋움"><?=M_CLOSED.M_FEE?></font>
						</div>
					</td>
