...
$query_pdo = "SELECT c_bank,c_banknum,c_account,c_use,c_signdate,c_no, IFNULL(c_delete,0) FROM $table_bank ";

if ($key != "") {
	$query_pdo .= " where $keyfield LIKE '%$key%' AND IFNULL(c_delete, 0) <> 1 ";
}
$query_pdo .= "ORDER BY c_signdate DESC";
	...
	<tr>
		<td>
			<table width="100%" border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class='td14' align="center"><?=M_ACCOUNT." ".M_MANAGEMENT?></td>
					<td align="center">
			...
			<td>
					...
					<tr>
						...
						<td height="20" align="center">
							...
							<select name="keyfield">
								<option value="c_banknum" <? if ($keyfield == 'c_banknum') echo ("selected"); ?>><?=M_ACCOUNT?></option>
							</select>
				...
				<table width="900" border='0' cellspacing='0' cellpadding='0'>
					<tr align="center" bgcolor='#ffffff' class="list_title">
						...
						<td width="100" height="30"><?=M_BANK?></td>
						<td width="150" height="30"><?=M_ACCOUNT?></td>
						<td width="90" height="30"><?=M_ACCOUNT_OWNER?></td>
						<td width="90" height="30"><?=M_USE?></td>
					...
					<tr align="center" bgcolor='#f8f8f8'>
						...
						<td height="30"><a href="member_modify.php?<?= $mode ?>&page=<?= $page ?>&c_no=<?= $c_no ?>"><?= $c_bank ?></td>
						<td height="30"><a href="member_modify.php?<?= $mode ?>&page=<?= $page ?>&c_no=<?= $c_no ?>"><B><?= $c_banknum ?></B>
							</a>
						</td>
						<td height="30"><?= $c_account ?></td>
						<td height="30"><?= $c_use ?></td>
						<td><?= $c_signdate ?></td>
