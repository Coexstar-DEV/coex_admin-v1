...
$qry = "SELECT * FROM $stake WHERE m_userno = ? AND m_tno = ?";
$stmt1 = $pdo->prepare($qry);
$stmt1->execute(array($t_userno, $t_no));
$row1 = $stmt1->fetch();

$s_userno = $row1['m_userno'];
$s_tno = $row1['m_tno'];
$s_mno = $row1['m_no'];
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
	...
	<input type="hidden" name="s_userno" value="<? echo $s_userno ?>">
	<input type="hidden" name="s_tno" value="<? echo $s_tno ?>">
	<input type="hidden" name="s_mno" value="<? echo $s_mno ?>">
	</form>
</table>
