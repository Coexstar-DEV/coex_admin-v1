	...
	<tr>
		<td>
			<table align="center" width="1000" border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class='td14' align="center">Deposit Audit Trail</td>
				</tr>
                </table>
        </td>
  </tr>
...
<div class="panel panel-warning ">
            ...
            <form id="generate-gg-form" role="form" target="_blank" action="member_deppdf.php?from=<?php echo $from; ?>&to=<?php echo $to; ?>&c_coin=<?php echo $c_coin; ?>&m_id=<?php echo $m_id; ?>&emp_status=<?php echo $emp_status; ?>&emp_range=<?php echo $emp_range; ?>&m_age=<?php echo $m_age; ?>">
    ...
    <div class="col-sm-4" id="emp_status">
        <div class="form-group">
            ...
            <option value="" <?php if(isset($emp_status) && $emp_status == '') { ?>selected <?php } ?>>--Select--</option>
                ...
                <option value="Others" <?php if(isset($emp_status) && $emp_status == 'Student') { ?>selected <?php } ?>>Others</option>
            </select>
        </div>
    </div>
...
<br>
             ...
             <form name=dform action="dep_excel.php" method=post target="_blank">
