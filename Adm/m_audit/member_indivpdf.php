  ...
  if(isset($_GET['email'])) 
  {
    ...
    $row = $stmt2->fetch(PDO::FETCH_ASSOC);
             ...
             $html = "<html>
                ...
                <body>
                    <p style='font-size: 20px; font-weight: bold;'>Withdrawal Form</p>
                    ...
                    ";
                            ...
                            $html .= "
                                <tr>
                                    ...
                                    <input type='radio' id='transfer' name='payment' value='bank1'> Bank Transfer 
                                    <br>
                                    <input type='radio' id='cheque1' name='payment' value='cheque1'> Cheque Payment 
                                    </td>" . " 
                                    <td style='font-size: 12px; float: left;  padding: 3px;'>
...
$mpdf->Output();
$m_module = "Withdrawal PDF Form";
$m_type = "Download";
$m_signdate = time(); 


$m_modified =  "Generated Withdrawal PDF Form";
