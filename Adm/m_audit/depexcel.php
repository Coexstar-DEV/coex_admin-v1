...
$query_pdo = "SELECT m_name, m_id, m_empstatus, m_position, m_empsalary, m_signdate, m_level, c_return, FROM_UNIXTIME(cp.c_signdate+8*3600) as c_sign, cs.c_coin, TIMESTAMPDIFF(YEAR, m_birtday, CURDATE()) as m_age FROM $member as mm INNER JOIN $table_point as cp on mm.m_id = cp.c_id INNER JOIN $table_setup AS cs on cp.c_div = cs.c_no WHERE  cp.c_category = 'reqorderrecv' ";
    ...
    <tr align="center">
		...
		<?
            ...
            <tr  align="center">
              ...
              <td width='150' height='30'><?=   $row['c_sign'] ?> </td>
