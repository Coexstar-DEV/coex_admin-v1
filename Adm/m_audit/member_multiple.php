	...
	<tr>
		<td>
			<table align="center" width="1000" border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class='td14' align="center">Multiple Accounts Audit Trail</td>
				</tr>
                </table>
        </td>
  </tr>
...
<div class="panel panel-warning ">
            <div class="panel-heading">Multiple Accounts </div>
            <div class="panel-body"> 
			<form id="generate-gg-form" role="form" target="_blank" action="member_mulpdf.php?m_name=<?php echo $m_name; ?>&m_birtday=<?php echo $m_birtday;?>">


<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            <label class="control-label">Member Name <span class="label label-danger">Required</span> </label>
            <input type="text" name="m_name" class="form-control" id="m_name" value="<?php if(isset($m_name)) echo $m_name; ?> " required/>
        </div>
        <div class="form-group">
            <label class="control-label">Member Birthday (yyyymmdd)
            <input type="text" name="m_birtday" class="form-control" id="m_birtday" value="<?php if(isset($m_birtday)) echo $m_birtday;?>" />
        </div>
    </div>
</div>
...
<div class="row generate-buttons" style="text-align:center">
    <div class="col-sm-12">
        <button type="submit" class="btn btn-default" style="color: #F9A602" id="btn-generate">Generate PDF</button>
