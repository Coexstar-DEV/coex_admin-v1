	...
	<tr>
		<td>
			<table align="center" width="1000" border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class='td14' align="center">Trading Audit Trail</td>
				</tr>
                </table>
        </td>
  </tr>
...
<div class="panel panel-warning ">
            <div class="panel-heading">Trading History </div>
            <div class="panel-body"> 
            <form id="generate-gg-form" role="form" target="_blank" action="member_tradepdf.php?from=<?php echo $from; ?>&to=<?php echo $to; ?>&m_id=<?php echo $m_id; ?>&emp_status=<?php echo $emp_status; ?>&emp_range=<?php echo $emp_range; ?>&m_age=<?php echo $m_age; ?>">
    ...
    <div class="col-sm-4" id="emp_status">
        <div class="form-group">
            ...
            <select class="form-control" name="emp_status" id="emp_status">
                <option value="All" <?php if(isset($emp_status) && $emp_status == 'All') { ?>selected <?php } ?>>All</option>
    ...
    <div class="col-sm-4" id="emp_range">
        <div class="form-group">
            ...
            <select class="form-control" name="emp_range">
                <option value="All" <?php if(isset($emp_range) && $emp_range == 'All') { ?>selected <?php } ?>>All</option>
    ...
    <div class="col-sm-4" id="m_age">
        <div class="form-group">
            ...
            <select class="form-control" name="m_age">
                <option value="All" <?php if(isset($m_age) && $m_age == 'All') { ?>selected <?php } ?>>All</option>
...
<br>
                      ...
                      <form name=dform action="trade_excel.php" method=post target="_blank">
