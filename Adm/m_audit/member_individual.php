	...
	<tr>
		<td>
			<table align="center" width="1000" border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class='td14' align="center">Withdrawal PDF</td>
				</tr>
                </table>
        </td>
  </tr>
...
<div class="panel panel-warning ">
            <div class="panel-heading">Withdrawal Form </div>
            <div class="panel-body"> 
			<form id="generate-gg-form" role="form" method="GET" target="_blank" action="./member_indivpdf.php?email=<?php echo $email; ?>">

<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            <label class="control-label">User ID <span class="label label-danger">Required</span> </label>
            <input type="text" name="email" class="form-control" id="email" value="<?php if(isset($email)) echo $email; ?>" required/>
        </div>
    </div>
</div>
