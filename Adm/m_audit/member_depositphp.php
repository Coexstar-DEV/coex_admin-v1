	...
	<tr>
		<td>
			<table align="center" width="1000" border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class='td14' align="center">PHP Deposit Audit Trail</td>
				</tr>
                </table>
        </td>
  </tr>
...
<div class="panel panel-warning ">
            ...
            <form id="generate-gg-form" role="form" target="_blank" action="member_depphp.php?from=<?php echo $from; ?>&to=<?php echo $to; ?>&c_coin=<?php echo 'PHP'; ?>&m_id=<?php echo $m_id; ?>&emp_status=<?php echo $emp_status; ?>&emp_range=<?php echo $emp_range; ?>&m_age=<?php echo $m_age; ?>">
