...
if(($_SESSION['new'])) {
  ...
  if($aa == 'Daily'){
    ...
    WHERE c_signdate > (1570406400 + 8*3600) and c_signdate < (unix_timestamp(NOW()) + 8*3600) and c_id <> 'coex@miner.net' and  c_pay = $cpay and c_div = $cdiv  and c_category = 'tradesell'
